...
package org.workspace7.fuse.tracing.demo;
 ...
 * @author kameshs
 */
public class TracedRouteBuilder extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        HttpClient httpClient = TracingHttpClientBuilder.create(httpTracing).build();
        ...
        from("jetty:http://localhost:8085")
                .to(httpEndpoint)
                .setBody(simple("${body}"))
                .log("${body}");
    }
